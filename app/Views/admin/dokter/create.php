...
<?= $this->section('title') ?>Tambah Dokter Baru<?= $this->endSection() ?>
  ...
  <div class="col-lg-8">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="<?= base_url('admin/dokter/store') ?>" method="POST">
          <?= csrf_field() ?>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="jadwal_praktek" name="jadwal_praktek" rows="3"></textarea>
          </div>
